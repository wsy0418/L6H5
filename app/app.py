...
def hello_world():
    ...
    if request_type_str == 'GET':
        ...
        model = load('app/bag-recommender.joblib')
        ...
        return render_template('index.html', href2='The suitable bag for you (age:'+str(myage)+' ,gender:'+str(mygender)+') is:'+predictions_to_str)
